...
{
    public abstract class BaseKernelMemoryTest : TextWriter
    {
        protected ITestOutputHelper Output { get; }

        protected ILoggerFactory LoggerFactory { get; }

        protected BaseKernelMemoryTest(ITestOutputHelper output)
        {
            this.Output = output;
        ...
        public override void Write(object? value = null)
            => this.Output.Write(value ?? string.Empty);
        ...
        public override void Write(char[]? buffer)
            => this.Output.Write(new string(buffer));
    ...
    public static class TextOutputHelperExtensions
    {
        ...
        {
            testOutputHelper.Write(string.Empty);
        }
        ...
        {
            testOutputHelper.Write(target.ToString());
        }
    }
}